import { purchaseOrderTable as purchaseOrder, type PurchaseOrder } from "@/db/schema"
 ...
 */
export function getStatusIcon(status: PurchaseOrder["status"]) {
  const statusIcons = {
    canceled: CircleX,
    done: CheckCircle2,
    "in-progress": Timer,
 ...
 */
// export function getPriorityIcon(priority: PurchaseOrder["priority"]) {
//   const priorityIcons = {
//     high: ArrowUpIcon,
//     low: ArrowDownIcon,
