...
const chartData = [
  ...
  { browser: "other", visitors: 90, fill: "#2563EB" },
]

const chartConfig = {
    allocatedDepartment: { label: "Department", color: "hsl(var(--chart-1))" },
...
export function DonutChart() {
    ...
    const aggregatedData = aggregateByKey(typedData, "allocationDepartment", "totalCost");
    ...
    console.log("ext. aggr", extendedAggregatedData)

  return (
    <Card className="flex flex-col border-none outline-none">
      <CardHeader className="items-left pb-0">
        <CardTitle className="">Total Budget By Department</CardTitle>
